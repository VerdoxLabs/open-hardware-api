...
import de.verdox.hwapi.catalog.domain.values.M2Slot;
import de.verdox.hwapi.catalog.domain.values.PcieSlot;
import de.verdox.hwapi.catalog.domain.values.USBPort;
