...
public abstract class AbstractMultiCasekingScraper<HARDWARE extends HardwareSpec> extends MultiPageHardwareScraper<HARDWARE> {
    ...
    public static class Builder<HARDWARE extends HardwareSpec> {
        ...
        public Builder<HARDWARE> withSpecsTranslation(BiConsumer<HARDWARE, Map<String, List<String>>> specsTranslation) {
            this.logic = specsTranslation;
            return this;
        }

        public AbstractMultiCasekingScraper<HARDWARE> build() {
