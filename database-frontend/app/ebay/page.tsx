...
export default function EbayPage() {
    ...
    return <main className="content ebay-page">
        <div className="page-links"><Link href="/" className="back-link">← Zur Datenbank</Link><Link href="/reviews/" className="back-link">Review Queue →</Link></div>
        <div className="page-intro"><div><span className="kicker">MARKETPLACE PRICE INTELLIGENCE</span><h2>Aktive Angebote von eBay & Kleinanzeigen</h2><p>Wähle ein Hardware-Produkt aus und starte einen kombinierten Lookup für aktuell inserierte Angebote.</p></div></div>
